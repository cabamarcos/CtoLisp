...
sentencia_declaraciones: INTEGER IDENTIF '=' expresion ',' sentencia_declaraciones { sprintf (temp, "(setq %s %s) %s", $2.code, $4.code, $6.code) ; 
            ...
            | IDENTIF '[' expresion ']' '=' NUMBER ',' sentencia_declaraciones { sprintf (temp, "(setf (aref %s %s) %d) %s", $1.code, $3.code, $6.value, $8.code) ;
                                                $$.code = gen_code (temp) ; }

            | IDENTIF '[' expresion ']' '=' NUMBER  { sprintf (temp, "(setf (aref %s %s) %d)", $1.code, $3.code, $6.value) ;
                                                $$.code = gen_code (temp) ; }
